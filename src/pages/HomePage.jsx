          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Bergabunglah dengan Kelas Ngoding kami dan mulai perjalananmu
                dalam dunia web development. Kami menyediakan berbagai kelas
                yang sesuai dengan level keahlianmu, mulai dari pemula hingga
                tingkat lanjut.
              </p>
              <button
              ...
              <button className="btn btn-outline-danger btn-lg rounded-1mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s">
                Lihat Promo
              </button>
            </Col>
            <Col
          ...
          <Row>
            <Col>
              ...
              <p className="text-center">
                Menjadi Full-Stack Developer dengan kurikulum komprehensif!
              </p>
            </Col>
          </Row>
              ...
              return (
                ...
                >
                  <img
                    src={kelas.image}
                    alt="unsplash.com"
                    className="w-100 mb-5 rounded-1"
                  />
